        ...
        implements WeekView.EventClickListener, MonthLoader.MonthChangeListener, WeekView.EventLongPressListener, WeekView.EmptyViewLongPressListener, WeekView.EmptyViewClickListener
{
    ...
    private static final int PROJECTION_EVENT_COLOR = 3;
    ...
    public void onEmptyViewClicked(Calendar time) {
        ...
        EditText titulo = (EditText) dialog.findViewById(R.id.titulo);

        Spinner tipoServicio = (Spinner) dialog.findViewById(R.id.spinner_tipo);
        ...
        TimePicker timePickerInicio = (TimePicker)dialog.findViewById(R.id.horaInicio);
        timePickerInicio.setIs24HourView(true);

        TimePicker timePickerFin = (TimePicker)dialog.findViewById(R.id.horaFin);
        timePickerInicio.setIs24HourView(true);

        Button dialogButton = (Button) dialog.findViewById(R.id.botonGuardar);
    ...
    public void onEventLongPress(WeekViewEvent event, RectF eventRect) {
        Toast.makeText(this, "LongClicked " + event.getName(), Toast.LENGTH_SHORT).show();
    }
    ...
    private List<WeekViewEvent> getEvents(int mes, int anyo){

        List<WeekViewEvent> ret = new ArrayList<>();

        Calendar beginTime = Calendar.getInstance();
        beginTime.set(anyo, mes, 1, 8, 0);
        long startMillis = beginTime.getTimeInMillis();
        Calendar endTime = Calendar.getInstance();
        endTime.set(anyo, mes, 31, 8, 0);
        ...
        while (cur.moveToNext()) {
            ...
            Log.i(DEBUG_TAG, "Date: " + formatter.format(calendarBegin.getTime()) + " to " + formatter.format(calendarEnd.getTime()));

            // Populate the week view with some events.
            WeekViewEvent event = new WeekViewEvent();
            event.setColor(getResources().getColor(R.color.colorSocoExterior));
            event.setName(title);
